...
// --- ROTA RELATÓRIO: ÚLTIMO ACESSO ---
app.get('/api/relatorio-ultimo', proteger, async (req, res) => {
    try {
        // 1. Pega a data do último acesso salva
        ...
        // Verifica se é o mesmo dia (Horário de Brasília)
        const mesmoDia = ultimoAcesso.toLocaleDateString('pt-BR') === agora.toLocaleDateString('pt-BR');

        if (mesmoDia) {
            // Se for o mesmo dia, mostra de 00:00 até 23:59 de hoje
            ...
            // Se for dia diferente, mostra desde o último clique até agora
        ...
        // 2. Atualiza o marcador para agora
...
// FUNÇÕES DE STATUS E OUTRAS ROTAS (IGUAIS ÀS ANTERIORES)
